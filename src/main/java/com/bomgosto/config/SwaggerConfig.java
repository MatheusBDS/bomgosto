...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.bomgosto.resources"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "API Pizzaria e Restaurante Bom Gosto",
                "Esta API é utilizada como regra de negócio da pizzaria para realização dos pedidos",
                "Versão 1.0",
                null,
                null,
                null,
